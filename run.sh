...
mkdir -p /root/paddlejob/workspace/output/model/G
mkdir -p /root/paddlejob/workspace/output/model/D/0
mkdir -p /root/paddlejob/workspace/output/model/D/1 
mkdir -p /root/paddlejob/workspace/output/model/D/2 
mkdir -p /root/paddlejob/workspace/output/tmp_images
unzip dd.zip -d /root/paddlejob/workspace/code
unzip mm.zip -d /root/paddlejob/workspace/code
